    ...
    <div className="relative">
      <div className="flex">
        <div className="w-1/2 p-8 ml-20 mt-40">
          <h1 className="text-gray-700 font-sans text-4xl font-bold whitespace-no-wrap">
            Núcleo De Umbanda Sagrada
          </h1>
          <p className="max-w-md text-gray-500 mb-4 mt-6">
            Faça login ou registre-se para começar a utilizar a plataforma
          </p>
          ...
          <form>
            ...
            <div className="mb-2">
              <div className="flex items-center justify-between w-96">
                <label className="text-sm font-medium text-gray-600 mr-2 mb-2">
                  Senha
                </label>
                <a href="#" className="text-sm font-bold text-purple-600 mb-2">
                  Esqueceu a senha?
                </a>
              </div>
